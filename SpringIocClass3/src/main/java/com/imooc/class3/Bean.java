...
public class Bean {
    ...
    private Map<AnotherBean,AnotherBean> anotherBeanAnotherBeanMap;
    ...
    public Map<AnotherBean, AnotherBean> getAnotherBeanAnotherBeanMap() {
        return anotherBeanAnotherBeanMap;
    }

    public void setAnotherBeanAnotherBeanMap(Map<AnotherBean, AnotherBean> anotherBeanAnotherBeanMap) {
        this.anotherBeanAnotherBeanMap = anotherBeanAnotherBeanMap;
    }
    ...
    public String toString() {
        return "Bean{" +
                ...
                ", stringMap=" + stringMap +
                ", anotherBeanAnotherBeanMap=" + anotherBeanAnotherBeanMap +
